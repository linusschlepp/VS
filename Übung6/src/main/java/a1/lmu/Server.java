...
public class Server implements IFEarlyDetection  {
    ...
    @Override
    public Report analyze(IFXRay ifxRay) throws RemoteException {
        ...
        try {
            ...
            Color color = new Color(ImageIO.read(new ByteArrayInputStream(ifxRay.getRawData())).getRGB(1, 1), true);
